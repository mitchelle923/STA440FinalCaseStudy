---
title: "STA 440 Individual Case Study"
...
SurgeryTiming <- read.csv("~/STA 440/Individual Case Study/SurgeryTiming.csv", row.names=NULL)
```
...
These are the three main objectives for this study:

1)  Is there an association between 30-day mortality and the day of the week in which an operation occurs?
2)  Is there an association between 30-day mortality and the time of day in which an operation occurs?
3)  Is there an association between 30-day mortality and the month of the year in which an operation occurs?
...
model <- glm(mort30 ~ age+hour+dow+month+ moonphase, data = SurgeryTiming, family = "binomial")
...
category_colors <- c("January" = "gray", "February" = "gray", "March" ="gray", "April" = "gray", "May" = "gray", "June" = "gray", "July" = "red", "August" = "red", "September" = "grey", "October"="grey", "November"= "grey", "December" = "grey")

eleven <- ggplot(SurgeryTiming, aes(x = month)) + geom_bar(fill = category_colors) + labs(title = "11) Distribution of Month of Year", x = "Month of Year", y = "Count") +
...
*Image 14) Hour and 30 Day Morality*
